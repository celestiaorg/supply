...
graph TB
    subgraph "Circulating Supply Calculation"
        style CirculatingSupply fill:#a3bcb6, stroke:#ffffff, stroke-width:2px, shape:rect
    ...
    classDef sameColor fill:#a3bcb6,stroke:#ffffff,stroke-width:2px, shape:rect;
    classDef inputColor fill:#b48ead,stroke:#ffffff,stroke-width:2px, shape:rect;
    classDef eventColor fill:#ebcb8b,stroke:#ffffff,stroke-width:2px, shape:rect;
...
graph TB
    subgraph "Total Supply Calculation"
        style TotalSupply fill:#a3bcb6, stroke:#ffffff, stroke-width:2px, shape:rect
